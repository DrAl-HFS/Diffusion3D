...
extern void split3 (int v[3], ClustIdx o, const Stride stride[3]);
...
extern void clusterSortAbsID (int i[], U32 n); // { qsort(i, n, sizeof(I32), {abs(b)-abs(a)} ); }

extern void clusterAssess (const ClustIdx ni[], const size_t nNI);
